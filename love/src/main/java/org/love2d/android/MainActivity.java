...
clearSeasonsMenu();
ImageView allback_images = (ImageView) MainActivity.this.findViewById(R.id.allback_images); 	
...
Button start_the_game_button = (Button) MainActivity.this.findViewById(R.id.start_the_game_button);
start_the_game_button.setVisibility(View.VISIBLE);
start_the_game_button.setEnabled(true);
Button training = (Button) MainActivity.this.findViewById(R.id.training);
training.setVisibility(View.VISIBLE);
training.setEnabled(true);	
Button game_page = (Button) MainActivity.this.findViewById(R.id.game_page);
game_page.setVisibility(View.VISIBLE);
game_page.setEnabled(true);	
Button comments = (Button) MainActivity.this.findViewById(R.id.comments);
comments.setVisibility(View.VISIBLE);
comments.setEnabled(true);		
Button send_email = (Button) MainActivity.this.findViewById(R.id.send_email); 
send_email.setVisibility(View.VISIBLE);
send_email.setEnabled(true);	
Button group_games_page = (Button) MainActivity.this.findViewById(R.id.group_games_page); 
group_games_page.setVisibility(View.VISIBLE);
group_games_page.setEnabled(true);		
Button exit_button = (Button) MainActivity.this.findViewById(R.id.exit_button); 
...
Button BackToBase = (Button) MainActivity.this.findViewById(R.id.BackToBase);
BackToBase.setVisibility(View.VISIBLE);
BackToBase.setEnabled(true);
Button sOne = (Button) MainActivity.this.findViewById(R.id.sOne);
sOne.setVisibility(View.VISIBLE);
sOne.setEnabled(true);	
Button sTwo = (Button) MainActivity.this.findViewById(R.id.sTwo);
sTwo.setVisibility(View.VISIBLE);
sTwo.setEnabled(true);	
Button sThree = (Button) MainActivity.this.findViewById(R.id.sThree);
sThree.setVisibility(View.VISIBLE);
sThree.setEnabled(true);		
Button sFour = (Button) MainActivity.this.findViewById(R.id.sFour); 
...
Button BackToSeasonsFromOne = (Button) MainActivity.this.findViewById(R.id.BackToSeasonsFromOne);
BackToSeasonsFromOne.setVisibility(View.VISIBLE);
BackToSeasonsFromOne.setEnabled(true);
Button sOneEone = (Button) MainActivity.this.findViewById(R.id.sOneEone);
sOneEone.setVisibility(View.VISIBLE);
sOneEone.setEnabled(true);	
Button sOneEtwo = (Button) MainActivity.this.findViewById(R.id.sOneEtwo);
sOneEtwo.setVisibility(View.VISIBLE);
sOneEtwo.setEnabled(true);	
Button sOneEthree = (Button) MainActivity.this.findViewById(R.id.sOneEthree);
...
Button BackToSeasonsFromTwo = (Button) MainActivity.this.findViewById(R.id.BackToSeasonsFromTwo);
BackToSeasonsFromTwo.setVisibility(View.VISIBLE);
BackToSeasonsFromTwo.setEnabled(true);
Button sTwoEone = (Button) MainActivity.this.findViewById(R.id.sTwoEone);
sTwoEone.setVisibility(View.VISIBLE);
sTwoEone.setEnabled(true);	
Button sTwoEtwo = (Button) MainActivity.this.findViewById(R.id.sTwoEtwo);
sTwoEtwo.setVisibility(View.VISIBLE);
sTwoEtwo.setEnabled(true);	
Button sTwoEthree = (Button) MainActivity.this.findViewById(R.id.sTwoEthree);
...
Button BackToSeasonsFromThree = (Button) MainActivity.this.findViewById(R.id.BackToSeasonsFromThree);
BackToSeasonsFromThree.setVisibility(View.VISIBLE);
BackToSeasonsFromThree.setEnabled(true);
Button sThreeEone = (Button) MainActivity.this.findViewById(R.id.sThreeEone);
sThreeEone.setVisibility(View.VISIBLE);
sThreeEone.setEnabled(true);	
Button sThreeEtwo = (Button) MainActivity.this.findViewById(R.id.sThreeEtwo);
sThreeEtwo.setVisibility(View.VISIBLE);
sThreeEtwo.setEnabled(true);	
Button sThreeEthree = (Button) MainActivity.this.findViewById(R.id.sThreeEthree);
...
Button BackToSeasonsFromFour = (Button) MainActivity.this.findViewById(R.id.BackToSeasonsFromFour);
BackToSeasonsFromFour.setVisibility(View.VISIBLE);
BackToSeasonsFromFour.setEnabled(true);
Button sFourEone = (Button) MainActivity.this.findViewById(R.id.sFourEone);
sFourEone.setVisibility(View.VISIBLE);
sFourEone.setEnabled(true);	
Button sFourEtwo = (Button) MainActivity.this.findViewById(R.id.sFourEtwo);
sFourEtwo.setVisibility(View.VISIBLE);
sFourEtwo.setEnabled(true);	
Button sFourEthree = (Button) MainActivity.this.findViewById(R.id.sFourEthree);
